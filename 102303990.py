...
def validate_inputs(args):
    if len(args) != 5:
        print("Usage: python 102303990.py <SingerName> <NumberOfVideos> <AudioDuration> <OutputFileName>")
        print('Example: python 102303990.py "Sharry Maan" 20 20 102303990-output.mp3')
        sys.exit(1)
